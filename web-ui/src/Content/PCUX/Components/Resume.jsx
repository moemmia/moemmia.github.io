      ...
      <Tabs width="350px" defaultActiveTab="About">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Fieldset legend="a Software Engineer" width="100%">
              <Frame display="flex" flexDirection="column" padding="$10">
                passionate about accessibility, user interaction, and creating inclusive, intuitive
                digital experiences across all devices. Committed to innovation and continuous
                improvement.
              </Frame>
            </Fieldset>
          </div>
        ...
        <Tab title="Experience">
          <Fieldset legend="" width="100%">
            <Frame padding="$10">
              <Checkbox readOnly checked>
                <b>Immersive Technologies Developer</b> at CTIC Technological Center (Oct 2021 –
                Present)
              </Checkbox>
