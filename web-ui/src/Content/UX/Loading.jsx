...
export function Loading({ progress, onStart }) {
  ...
  useEffect(() => {
    if (displayProgress >= 100) {
      const timeout = setTimeout(() => setFinished(true), 200);
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="absolute top-0 left-0 w-[100svw] h-[100svh] flex flex-col items-center justify-center bg-[#94ab9e] z-[9999] overflow-hidden"
